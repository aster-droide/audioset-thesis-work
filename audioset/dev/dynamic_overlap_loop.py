...
def dynamic_loop_audio(file_path, target_frame_length_ms, overlap_percentage):
    ...
    if original_duration_ms < 1000:
        total_required_duration_ms = max(total_required_duration_ms, 1000)
...
def process_folder_dynamic_looping(input_folder, output_folder, frame_length_ms=1000, overlap_percentage=0.5):
    """
...
input_folder = '/Users/astrid/Documents/Thesis/MEOWS/FreshMeowFolderFeb24/catmeow-dataset-simone-trimmed-as-is'
output_folder = '/Users/astrid/Documents/Thesis/MEOWS/FreshMeowFolderFeb24/simone-looped-may-24'
